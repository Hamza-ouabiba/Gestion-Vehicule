        ...
        If compteur_voiture < 100 Then
            ...
            If Nom.Text <> "" And matricule.Text <> "" And place.Text <> "" And (peugeot.Text <> "" Or citroen.Text <> "" Or autre.Text <> "") And entree.Text <> "" And sortie.Text <> "" Then
                If peugeot.Checked = True Then
                    voiture(compteur_voiture) = New Voiture(Nom.Text, matricule.Text, place.Text, peugeot.Text, entree.Text, sortie.Text)
                    With ListView1.Items.Add(voiture(compteur_voiture).chauffeur)
                        .SubItems.Add(voiture(compteur_voiture).immatriculation)
                        .SubItems.Add(voiture(compteur_voiture).nombre_place)
                ...
                ElseIf citroen.Checked = True Then
                    voiture(compteur_voiture) = New Voiture(Nom.Text, matricule.Text, place.Text, citroen.Text, entree.Text, sortie.Text)
                    With ListView1.Items.Add(voiture(compteur_voiture).chauffeur)
                        .SubItems.Add(voiture(compteur_voiture).immatriculation)
                        .SubItems.Add(voiture(compteur_voiture).nombre_place)
                        .SubItems.Add(voiture(compteur_voiture).marque)
                    ...
                    compteur_voiture += 1
                Else
                    voiture(compteur_voiture) = New Voiture(Nom.Text, matricule.Text, place.Text, autre_.Text, entree.Text, sortie.Text)
                    With ListView1.Items.Add(voiture(compteur_voiture).chauffeur)
                        .SubItems.Add(voiture(compteur_voiture).immatriculation)
                        .SubItems.Add(voiture(compteur_voiture).nombre_place)
                        .SubItems.Add(voiture(compteur_voiture).marque)
